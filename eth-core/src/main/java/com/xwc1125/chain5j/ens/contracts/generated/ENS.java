...
import com.xwc1125.chain5j.abi.datatypes.generated.Uint64;
...
public class ENS extends Contract {
    ...
    public RemoteCall<TransactionReceipt> setSubnodeOwner(byte[] node, byte[] label, String owner) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(label),
                new com.xwc1125.chain5j.abi.datatypes.Address(owner)),
    ...
    public RemoteCall<TransactionReceipt> setTTL(byte[] node, BigInteger ttl) {
        final Function function = new Function(
                FUNC_SETTTL, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.generated.Uint64(ttl)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setResolver(byte[] node, String resolver) {
        final Function function = new Function(
                FUNC_SETRESOLVER, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.Address(resolver)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
