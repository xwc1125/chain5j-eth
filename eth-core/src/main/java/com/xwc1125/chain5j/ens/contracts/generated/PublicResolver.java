package com.xwc1125.chain5j.ens.contracts.generated;
...
import com.xwc1125.chain5j.abi.datatypes.DynamicBytes;
...
import com.xwc1125.chain5j.tuples.generated.Tuple2;
...
public class PublicResolver extends Contract {
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceID) {
        final Function function = new Function(FUNC_SUPPORTSINTERFACE, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes4(interfaceID)),
    ...
    public RemoteCall<TransactionReceipt> setText(byte[] node, String key, String value) {
        final Function function = new Function(
                FUNC_SETTEXT, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.Utf8String(key),
                new com.xwc1125.chain5j.abi.datatypes.Utf8String(value)),
    ...
    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function(FUNC_ABI, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.generated.Uint256(contentTypes)),
    ...
    public RemoteCall<TransactionReceipt> setPubkey(byte[] node, byte[] x, byte[] y) {
        final Function function = new Function(
                FUNC_SETPUBKEY, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(x),
                new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(y)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setABI(byte[] node, BigInteger contentType, byte[] data) {
        final Function function = new Function(
                FUNC_SETABI, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.generated.Uint256(contentType),
                new com.xwc1125.chain5j.abi.datatypes.DynamicBytes(data)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setName(byte[] node, String name) {
        final Function function = new Function(
                FUNC_SETNAME, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.Utf8String(name)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setContent(byte[] node, byte[] hash) {
        final Function function = new Function(
                FUNC_SETCONTENT, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(hash)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setAddr(byte[] node, String addr) {
        final Function function = new Function(
                FUNC_SETADDR, 
                Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.generated.Bytes32(node),
                new com.xwc1125.chain5j.abi.datatypes.Address(addr)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<PublicResolver> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new com.xwc1125.chain5j.abi.datatypes.Address(ensAddr)));
