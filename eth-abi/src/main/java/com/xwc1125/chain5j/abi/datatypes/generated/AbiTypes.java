 ...
 * <p>Please use com.xwc1125.chain5j.codegen.AbiTypesMapperGenerator in the
...
public final class AbiTypes {
    ...
    public static TypeReference<?> getTypeReference(String type) throws IllegalAccessException, InstantiationException {
        String baseType = "";
        if (type.endsWith("[]")) {
            // DynamicArray
