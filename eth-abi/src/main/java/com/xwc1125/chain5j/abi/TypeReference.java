 ...
 */
public abstract class TypeReference<T extends com.xwc1125.chain5j.abi.datatypes.Type>
    ...
    public static <T extends com.xwc1125.chain5j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.xwc1125.chain5j.abi.datatypes.Type>
