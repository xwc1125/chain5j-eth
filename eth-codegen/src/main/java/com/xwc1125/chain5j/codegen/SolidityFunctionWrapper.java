package com.xwc1125.chain5j.codegen;
...
import com.xwc1125.chain5j.utils.Collection;
import com.xwc1125.chain5j.utils.Strings;
import com.xwc1125.chain5j.utils.Version;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder,
        ...
        if (addresses != null) {
            ...
            // See com.xwc1125.chain5j.tx.Contract#getStaticDeployedAddress(String)
        ...
        if (parameterSpec.type instanceof ParameterizedTypeName) {
            ...
            if (typeNames.size() != 1) {
                ...
                return "new " + parameterSpecType + "(\n"
                        + "        " + componentType + ".class,\n"
                        + "        com.xwc1125.chain5j.abi.Utils.typeMap("
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType = ParameterizedTypeName.get(
                    ClassName.get(
                            "com.xwc1125.chain5j.tuples.generated",
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("com.xwc1125.chain5j.abi.datatypes.generated.StaticArray" + type);
